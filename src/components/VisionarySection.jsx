...
const investments = [
  { name: 'HIFI', entry: 'Seed', invested: '2024', sector: 'Payment Rails', logo: logo1, url: 'https://www.hifi.com/' },
  { name: 'utexo', entry: 'Seed', invested: '2025', sector: 'Stablecoin Settlement', logo: logo2, width: '70px', url: 'https://utexo.com/' },
  { name: 'Crosspoint', entry: 'Seed', invested: '2024', sector: 'Banking, Wallets & Custody', logo: logo3, width: '100px', url: 'https://www.crosspoint.global/' },
  { name: 'Momentum', entry: 'Pre-Seed', invested: '2025', sector: 'Programmable Finance', logo: logo4, width: '100px', url: 'https://app.mmt.finance/dashboard' },
  { name: 'NET', entry: 'Pre-Seed', invested: '2025', sector: 'Stablecoin Settlement', logo: logo5, width: '60px', url: 'https://opnet.org/' },
];
    ...
    <section className="vision-section container">
      <div className="vision-container">
        ...
        <div className="vision-card">
          {/* Left Side: Branded Box with image */}
          <div className="card-visual" style={{ background: 'transparent', boxShadow: 'none', padding: 0 }}>
            <img
              src={aetfiiImg}
              alt="Arcanum Emerging Technologies Fund II"
          ...
          <table className="invest-table">
            ...
            <tbody>
              {investments.map((item, idx) => (
                <tr key={idx} onClick={() => window.open(item.url, '_blank')}>
                  <td>
