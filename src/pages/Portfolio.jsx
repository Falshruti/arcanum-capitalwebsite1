...
// Fund II Logos
import hifiLogo from '../assets/fund2logos/hifi.png';
import momentumLogo from '../assets/fund2logos/momentum.png';
import neroLogo from '../assets/fund2logos/nero.png';
import ogLogo from '../assets/fund2logos/og.png';
import satlayerLogo from '../assets/fund2logos/satlayer.png';
...
const Portfolio = () => {
  ...
  const tableData = [
    ...
    { id: 37, fund: 'Fund II', name: 'Momentum', category: 'DEX & LIQUIDITY', date: '2025', entry: 'Pre-Seed', isImg: true, icon: momentumLogo, url: 'https://mmt.finance/' },
    { id: 38, fund: 'Fund II', name: 'NERO', category: 'MODULAR L1', date: '2025', entry: 'Seed', isImg: true, icon: neroLogo, url: 'https://nerochain.io/' },
    { id: 39, fund: 'Fund II', name: '0G Labs', category: 'AI INFRASTRUCTURE', date: '2024', entry: 'Seed', isImg: true, icon: ogLogo, url: 'https://0g.ai/' },
    { id: 40, fund: 'Fund II', name: 'OP_NET', category: 'BITCOIN APPS', date: '2025', entry: 'Pre-Seed', isImg: true, icon: logo5, url: 'https://opnet.org/' },
    { id: 41, fund: 'Fund II', name: 'SatLayer', category: 'BITCOIN SECURITY', date: '2024', entry: 'Seed', isImg: true, icon: satlayerLogo, url: 'https://satlayer.xyz/' },
    { id: 42, fund: 'Fund II', name: 'Sati', category: 'CRYPTO PAYMENTS', date: '2024', entry: 'Pre-Seed', isImg: true, icon: satiLogo, url: 'https://www.sati.pro/' },
    { id: 43, fund: 'Fund II', name: 'Showdown', category: 'WEB3 WAGERING', date: '2025', entry: 'Seed', isImg: true, icon: showdownLogo, url: 'https://showdown.me/' },
    { id: 44, fund: 'Fund II', name: 'Symphony', category: 'DIGITAL WEALTH', date: '2025', entry: 'Seed', isImg: true, icon: symphonyLogo, url: 'https://www.symphony.io/' },
    { id: 45, fund: 'Fund II', name: 'TR8DE.AI', category: 'AI TRADING TERMINAL', date: '2025', entry: 'Pre-Seed', isImg: true, icon: logo1, url: 'https://www.tr8de.ai/' },
    { id: 46, fund: 'Fund II', name: 'UTEXO', category: 'STABLECOIN SETTLEMENT', date: '2025', entry: 'Seed', isImg: true, icon: logo2, url: 'https://utexo.com/' },
    { id: 47, fund: 'Fund II', name: 'Zircuit', category: 'NEOFINANCE', date: '2024', entry: 'Seed', isImg: true, icon: zircuitLogo, url: 'https://www.zircuit.com/' },
  ];
